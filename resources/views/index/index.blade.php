...
@section('content')
            ...
            <div class="map-contact col-md-6 col-sm-6 bg-light-orange" @desktop style="height: 460px !important;" @enddesktop>
                <ul>
                    ...
                    <li>
                        ...
                        অনুদান জমা হবে ঢাকা ইউনিভার্সিটি আইটি সোসাইটি (ডিইউআইটিএস) এর শিক্ষার্থীদের উদ্যোগ "আর্থিক সহায়তা প্রদান তহবিল"-এ। আর্থিকভাবে অস্বচ্ছল সদস্যদের অথবা অসহায়দের জন্য এ অর্থ সঞ্চিত হবে।
                    </li> 
                    <li>
    ...
    <section class="fix-background white-text" style="background-image:url('/images/curzon.jpg');">
